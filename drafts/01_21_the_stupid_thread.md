# 01_21_the_stupid_thread — The Stupid Thread

## Status

L4 reconstruction outline parsed from latest user-provided chapter outline.

This chapter resolves the physical Ariadne’s Thread retrieval, turns the beacon from orange to red, returns the companions from Pollyr Fen to Aquila Matara, and starts the eight-day preparation clock for Horror.
...
- `drafts/01_20_the_red_thread_district.md`
- `locales/images/analysis/PFN.analysis.json`

## Placement

Immediately after `01_20_the_red_thread_district.md`.

This is the morning-after Red Thread District chapter. It begins in **The Ribbit Hole** and ends in Mae’s Aquila Matara manor dining room after the red beacon has activated.

## Calendar / Location Metadata

| Field | Value |
|---|---|
| Date | Hearthwake 17, Dravenkar. User lock: this is Day 17, with eight days left to handle Horror. |
| Start Time | Around 9:00 a.m. in Pollyr Fen. |
| Midpoint Time | Delayed departure from Pollyr Fen Portalport after red-beacon activation. |
| Aquila Matara Time | High Market, halfway toward Hour of the Wayfarer. |
| Beacon State | Starts orange active; Ariadne’s Thread touch triggers orange-to-red transition. Red active by AQM lunch. |
| Locations | The Ribbit Hole common room; The Ribbit Hole front door / street; Pollyr Fen Portalport; Aquila Matara terminal route; Mae’s Aquila Matara manor dining room. |
| Proposed Setting IDs | `SET-PFN-BROTHEL-HOUSE`; `SET-PFN-RED-THREAD-DISTRICT`; `SET-PFN-PORTALPORT`; `SET-AQM-TERMINAL`; `SET-AQM-MAE-DINING` |

## Chapter Function

This chapter should do six major things:

1. give a funny, human morning-after decompression scene in The Ribbit Hole;
2. resolve the actual Ariadne’s Thread object through Tallowmire’s child rather than through grand research;
3. use Mae’s mud-horror reaction for comedy and character contrast;
4. trigger the red beacon and start the final preparation clock;
5. move the companions back to Aquila Matara with news of city-allegiance declarations;
6. end on planning chaos and Addie realizing the next eight days will be brutal.

This is a hinge chapter: comic object delivery into final-beacon pressure.
...
## Pollyr Fen / The Ribbit Hole

- The Ribbit Hole manager.
- The Ribbit Hole staff.
- Two young workers Addie spoke with the previous night.
- Young male worker who brings the door message.
- Tallowmire’s adopted daughter, a five- or six-year-old frogfolk girl in a bright pink mud-covered dress.
- Street onlookers / neighbors.

## Aquila Matara Manor

- Max.
- Mae household staff optional.
...
3. Every companion was offered a room the previous night, but almost everyone fell asleep in the main room.
4. The sleep should feel earned, not luxurious:
   - the shelter night exhausted them;
   - the swamp trek nearly broke them;
   - the Red Thread District conversations let them finally stop bracing for a few hours.
5. Addie wakes disoriented and realizes she had not understood how tired she was.
6. She remembers talking with two young workers the previous night, alongside Mae and Gregory.
7. She thinks it had been strange but nice to talk about something besides:
   - what city they were going to next;
   - what constellation they were going to face;
   - how to stop the destruction of all old seventy-three cities in the world.
8. Addie laughs silently at how ridiculous that sounds when said plainly, even inside her head.
9. The Ribbit Hole staff are extra attentive this morning.
...
7. Schism cities appear to be the holdouts.
8. Addie thinks of course they are.
9. Addie expects Schism may not even send an update because no one will want to fill out the form.
10. Only two Concord cities remain undeclared:
   - Pollyr Fen;
   - Vyrath’Kai / VKI, the dragon home city.
...
4. They eat in Mae’s dining room rather than outside / on the porch.
5. Max is serving lunch.
6. He did not plan for them to be home, so lunch is just sandwiches.
...
- The establishment name is **The Ribbit Hole**. This has been back-applied to `01_20`.
- The woman who negotiated with Carrio in `01_20` should be treated as the manager, not the owner.
- Tallowmire’s daughter is adopted, frogfolk, five or six years old, delighted, muddy, and oblivious to how ominous adult phrases sound.
- Mae should be lethal and composed in almost every normal circumstance; the muddy knee-hug breaks her composure in a new way.
- Carrio’s prior people-read is validated: he sensed Tallowmire was protecting something precious, but he did not distinguish whether it was the child or the thread.
- Gregory should insist on precision: thread, not string.
- Red beacon activates when Addie touches the thread.
- The object is absurdly mundane and child-mishandled: mud, reeds, red thread, possibly once spherical.
- The comedy at the door should not erase the significance of the red beacon.
- This chapter begins on Day 17 with eight days left.

---

# Ending State

Ariadne’s Thread has been recovered.

The beacon has shifted from orange to red.

The companions have returned to Mae’s Aquila Matara manor.

City allegiance declarations are accelerating: most Concord and Ruin cities have declared, Schism lags, and Pollyr Fen plus Vyrath’Kai are the only remaining undeclared Concord cities.

The group has eight days to prepare for Horror.

Addie may have to face Horror alone.

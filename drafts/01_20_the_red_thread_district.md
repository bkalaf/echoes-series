# 01_20_the_red_thread_district — The Red Thread District

## Status

L4 reconstruction outline parsed from uploaded continuation after `01_19_the_well_of_souls.md`.

This is the Carrio-forward chapter: the companions exit the orange-waypoint visions believing the thread is still in Pollyr Fen, and Carrio deliberately leads them to the city’s red-light / pleasure district instead of back to the shelter.
...
- Fire dancer who briefly teaches Brickett basic fire handling.
- Workers who provide city-level political and social information.
...
The companions have shifted from official history / priestly memory to street-level testimony and sex-worker intelligence.

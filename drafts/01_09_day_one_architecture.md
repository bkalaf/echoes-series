# 01_09_day_one_architecture — Day One Architecture
...
- `### Chapter — Day One Architecture`

This chapter follows directly after `01_08_the_weight_of_being_asked.md` and before the Luminthalas lower-quarter search sequence in `Holes in the Wall`.

## Chapter Structure

This chapter is a transition / mobilization chapter.

It should remain a standalone parent chapter because it moves the story from household recovery into first-day operations:

1. Addie wakes after poor sleep.
2. Addie reclaims control through bath / hair / clothes.
3. The team plan is reviewed.
4. The manor is surrounded by reporters and protesters.
5. Mae’s household reveals its protective infrastructure.
6. The companions gather for breakfast in new field clothes.
7. Mae and Addie clash over information-hiding and trust.
8. The three-team operating plan locks.
9. Rhün reveals Brimscale and Ashwing as crowd-clearing assets.
10. Mae’s Nox Vaelor royal status is accidentally exposed.
11. The group exits into the public chaos.
...
This chapter gives the first operational morning after the mirror / companion-table night.

It does three important things:

- turns the companion group from a dinner table into field teams;
- exposes how public pressure immediately surrounds Addie’s new role;
- establishes that Mae’s household can outfit, protect, feed, and mobilize people at noble-house scale.
...
Tone: exhausted, tactical, domestic-comic under pressure, moving toward public danger.

This should feel like the brief morning inhale before the first field operation goes wrong.

## Timeline Position

Morning after:

- Addie’s Conclave speech;
- First Mirror / Second Mirror / Horror’s riddle;
- Mae estate dinner and companion consolidation.

Before:

- the group splits in Luminthalas;
- Addie, Mae, and Carrio search for Brynn in the lower quarters;
- `Holes in the Wall`.

## Parent Locations

- Mae’s guest bedroom / private quarters.
- Mae’s luxurious washroom / bath.
- Mae’s dining room.
- Mae’s foyer / front doors.
- Mae’s estate grounds / public exterior under reporter pressure.
...
- Barnaby, elderly froglok tailor / artisan.
- Mae household staff.
- Brimscale, ground-bound lava lizard / drake mount.
- Ashwing, flying fire drake.
- Young dark elf stable hand / courier.
- Reporters, protesters, house guards, crowd outside.
...
- Lavender/lilac steam nozzle.
- Cinnamon/cardamom crimson bath nozzle.
- Field outfit: deep-weave tunic, Gloamwood silk, dark reinforced leather, hidden padding.
- Note with two handwriting tones: polite outfit note + blood-on-foyer-floor warning.
- Expanded eighteen-chair breakfast table.
- Household staff eating alongside companions.
- Projection stone / broadcast loop of Addie in towel at window.
- New field clothes for everyone.
- Barnaby’s tailoring pride.
...
- Mae’s exposed title: Crown Princess of the royal house of Nox Vaelor.
- Yurislav’s coin / “Ditto” exit beat.

---

# Team Architecture

The morning plan splits the companions into three operational teams.

## Team One — Look Ahead / Bountiful Dam Search

**Members:** Matthieu, Yurislav, Major Tallandra.

**Destination:** Aes Sidhal, ancient Satyr city.
...
**Destination:** Historic archives of Luminthalas.
...
## Subchapter 1 — The Hour of the Wyrm

1. Morning arrives heavy and fog-bound.
...
1. Addie steps out of the bath area near the Hour of the Iron Foundry.
2. A roar and commotion outside draws her to the window.
3. She sees the manor surrounded by civilians, protesters, reporters, soldiers, and house guards.
4. Long-range lenses swivel up toward her window.
5. Addie realizes she is in a towel with wet cyan hair dye.
6. This becomes immediate public embarrassment and media fodder.
7. The beat should be funny but also threatening: Addie now has no private life.

## Subchapter 3 — Field Clothes

1. Addie discovers someone entered while she bathed.
2. New field outfit and note are laid out.
...
1. Addie enters the dining room late.
2. The table is full of food, staff, and companions.
...
10. Barnaby appears and confirms the clothes were custom-made overnight.
11. Barnaby’s craft joy and Mae’s playful bread-roll discipline reveal household culture.
12. Addie understands Mae’s household works through loyalty, freedom, and craft pride rather than fear.

## Subchapter 5 — Complete Honesty

1. Mae abruptly shifts tone.
2. She calls Addie out for filtering / withholding what happened in the mirrors.
...
1. Addie redirects to the day’s plan.
...
1. A young dark elf stable hand rushes in with sealed hemlock poison vials.
...
1. Max opens the obsidian doors.
2. Brimscale roars outside.
3. Ashwing sweeps overhead, scattering reporters.
4. The group steps into blinding morning light.
5. Yurislav runs his coin across his knuckles.
6. He says “Ditto,” echoing the prior night’s closing beat and carrying unresolved distrust / tension into the field.

---

# Required Canon Corrections From Source

Apply these corrections when converting prose or generating future drafts:

- Use **Mae’vyri H. Van’kareth** consistently.
...
This chapter is doing important connective work. It should not be skipped or collapsed into the Luminthalas arrival.

Preserve:

- Addie’s sleepless morning / bath / hair reset;
- reporter invasion of private space;
- new field clothes;
- Barnaby tailoring beat;
...
- Do not remove the bath / hair reset.
- Do not remove the reporter-window embarrassment.
- Do not remove field clothes.
- Do not remove Barnaby.
- Do not remove Mae confronting Addie about trust / information withholding.
- Do not remove Addie defending her mother’s memory.
- Do not remove the three-team split.
- Do not remove Brimscale or Ashwing.
- Do not remove the hemlock poison / “Your Highness” reveal.
- Do not remove Brickett identifying Mae’s royal title through census files.
- Do not remove Yurislav’s “Ditto.”

---

# Relationship To Next Chapter

Next source chapter: `Holes in the Wall`.

This chapter ends with the group leaving Mae’s estate under Brimscale / Ashwing crowd pressure.

`Holes in the Wall` should begin with the departure from the estate, the travel split, and Addie / Mae / Carrio entering the lower quarters of Luminthalas to find Brynn at The Bountiful Harvest.

---

# Open Questions / Follow-Up Flags

1. Confirm whether **Aes Sidhal** is the final spelling for the ancient Satyr city.
2. Decide whether `Hour of the Wyrm`, `Hour of the Iron Foundry`, and `Hour of the Aurora` are locked hour names or source-draft placeholders.
3. Confirm whether **Barnaby** is the final name/species for Mae’s froglok tailor.
4. Decide how much of Mae’s Crown Princess identity should be known by public record versus merely findable by Brickett.
5. Confirm Ashwing’s exact species wording: flying fire drake, dragon, or drake-like fire creature.
6. Consider adding Mae estate guest quarters / washroom to Settings if they recur.

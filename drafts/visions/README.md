...
This folder holds standalone vision fragments / sequences so the main chapter outlines can reference the vision files instead of carrying every vision inline.

## Naming Convention

- `01_01.md` through `01_06.md` — Book 01 vision sequence files.
- `17_01.md` — future Book 17 vision stub.
- `18_01.md` — future Book 18 vision stub.
...
| `01_02.md` | Corrected Extracted L4 | Second Mirror: Addie alone sees the original Dovren / Geoffrik / Overseer scene; the Overseer makes eye contact across the memory. |

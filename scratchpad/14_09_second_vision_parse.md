...
Parsed from uploaded source prose: `book14.md`, headed **Book 14 Canonical Unlocked Variant / Chapter 9: The Unwound Core**.
...
- The public was told they had roughly thirty years; the real window is five to ten years before the surface becomes unlivable.
...
- If migration population is placed into blackout, two million minds may wake as unrecoverable screaming lunatics.
...
- Silence intervenes in the submitted prose variant to stop Addie from pulling that thread too early.
- For the final Book 14 version, this moment should preserve the contradiction without resolving it immediately.
- The confusion is proof Addie is noticing the right structural problem, not a problem to solve in-scene.
...
- Twenty-four city-state logic originates as a deliberate governance architecture.

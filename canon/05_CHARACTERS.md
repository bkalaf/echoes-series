...
This file is a working character authority. Full character sheets should be expanded here as the manuscript develops.
...
- Central protagonist and hidden / returning companion structure.
- Archivist / public figure.
- Eidetic memory.
- ADHD-coded; analytical, overwhelmed, morally alert.
- Carries worn satchel and staff.
- Hair clip / clasp is important marker.
...
- Symbologist / priest-scholar archetype.
- Avoids spectacle.
- Photographic memory.
- Book 2 feat: Must Breathe Fire.
- Book 3 feat: Must Accept the Spotlight.
- The Sakura Branch matters because it is a branch, not a seed. Words matter.
...
- Must be brave enough to come out in Book 5.
...
- Reads threats.
- Calls the hour correction "Singularity."
...
- Serpent courtier / escort-intelligence companion.
- Elegant, system-aware, socially dangerous when necessary.
- Book 8 feat: Must Shed Skin.
- Book 9 feat: Must Not Be the Center of Attention.
- Should not become only comic relief or only seduction. Their function is social intelligence, survival through systems, and controlled self-reinvention.

### High Theorimist Mattieu H. Cardinal

- Mathematical / theoretical prodigy.
- Book 10 feat: Must Take on an Animal Spirit.
- Book 11 feat: Must Be Grounded and Ignore Mysticism.
- Arc tension: mysticism versus grounded reasoning.
- Should not be written as simply wrong because he is rational; his rationality is necessary, but incomplete.

### Mae'vyri H. Van'kareth

- Dark elf noble / assassin / business operator.
...
- Bearfolk warrior / right-glaive bearer.
- Reads emotion.
- Book 14 feat: Must Be Ruthless.
- Book 15 feat: Must Discover True Lineage with Mae.
- Should carry weight, restraint, battle-weariness, and deliberation.

### Rhun H. Ignis

- Draconic firebound rider.
- Book 16 feat: Must Hold Water.
- Book 17 feat: Has to Deal with Replacing Brynn.
- Fire identity should be pressured by water / containment / replacement themes.
...
- Born on Kindlemask.
- Reads the mundane and overlooked.

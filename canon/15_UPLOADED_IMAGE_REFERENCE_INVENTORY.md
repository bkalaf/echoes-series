...
- Images do **not** override locked names, species, ranks, spellings, ages, or plot canon.
- When two files depict the same figure, preserve both as visual modes unless one is explicitly superseded.
...
| Filename | Use |
|---|---|
| `initial_contact.jpg` | Contact sheet for initial companion/support/creature batch. |
| `architect_contact.jpg` | Contact sheet for human/council-form Architect batch. |

---

# Core / Companion / Support / Creature Images
...
| `overseer.png` | The Overseer | Ornate/courtly Overseer mode. |
| `the_overseer.png` | The Overseer | Scroll-delivery / procedural-interruption Overseer mode. |
| `rhun_h_ignis.png` | Rhun H. Ignis | Firebound rider / volcanic mount language. |
...
| `crown_architect.png` | Seraphine Iris Delacroix | Add legal cues: law tablets, seals, appeal ledgers, mandates. |
| `dominion_architect.png` | Malcolm Alistair MacRae | Strong controlled-security strategist reference. |
| `echoes_architect.png` | Corvin Alaric Vale | Strong archivist / record-access reference. |
| `harvest_architect.png` | Elowen Miriam Vale | Strong zoologist/species-steward reference. |
...
|---|---|---|
| `ash_witness.png` | Ash | Darker Ash mode; human recognition matters. |
| `ash_witness2.png` | Ash | Brighter Ash mode; useful as clearer faith-before-collapse reference. |
| `bastion_witness.png` | Bastion | White rhino guardian reference. |
| `crown_witness.png` | Crown | Add law/court/accountability cues so it does not become generic divinity. |
| `dominion_witness.png` | Dominion / Veils merged form | Use only for later merged Witness form; First Mirror council keeps Malcolm and Alessandra separate. |
...
| `omen_witness.png` | Omen / Foresight | Blue owl oracle; add anxiety / impossible probability cues. |
| `revel_witness.png` | Revel / Laughter | White treant festival host; add excess/instability if needed. |
| `sand_witness.png` | Sand | Green elephant historian among memory-stones; close to final. |
| `silence_witness.png` | Silence | Fox child with white mask; keep childlike and sideways, not majestic. |
| `stone_witness.png` | Stone | Green stone giant; add trapped/frozen life if needed. |
| `tempest_witness.png` | Tempest | Red draconic knight; add reconstruction/terraforming cues. |
| `tides_witness.png` | Tides | Green walrus underwater wanderer; add migration/current-line cues. |

---

# Repeated / Mode Records Worth Preserving

## Ash / Solomon

- `ash_architect.png`, `ash_witness.png`, and `ash_witness2.png` together create the recognition bridge.
- Solomon’s council form and Ash’s Witness form should remain recognizably related.

## Tallandra

- `cpt_talandra_h_highwatch.png` has useful context but incorrect visible text.
- `tallandra.png` is the cleaner canon visual candidate.
- Canon remains **Major Tallandra H. Highwatch**.

## Overseer

- `overseer.png` is the ornate/courtly mode.
- `the_overseer.png` is the scroll-delivery/procedural-interruption mode.
- Both are useful, but neither should be confused with Silence.

## Dovren

- `high_soverign_dovren_I.png` is Dovren I / first High Sovereign visual language.
- `high_soverign_dovren_LXX.png` is late-line Dovren visual language.
- Both filenames misspell Sovereign; canon spelling remains **High Sovereign**.

## Carrio

- `carrio_h_vessalor.png` = public court mask.
- `carrio_h_vessalor_2.png` = private strategist mode.

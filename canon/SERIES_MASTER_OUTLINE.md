...
It is intentionally not a prose draft. It is the map that decides where drafted chapter files, subchapter groups, research interludes, hidden-theme stubs, scratchpad planning, and crosslinked canon pieces belong.
...
- `canon/` = stable reference authority, continuity rules, rosters, indexes, and cross-book structure.

Do not place beat outlines or parsing documents in `chapters/` unless they have been converted into prose.

### 3. Do not renumber casually
...
### 4. Crosslinks are part of the architecture
Use crosslinks heavily. Drafts, canon files, research stubs, companion files, Witness files, scratchpad files, and book-level outlines should point to each other wherever the connection matters.
...
### 5. Stubs are allowed and encouraged
...
### 6. Hidden title messages are tracked here
...
### 7. Protected narrative fragments are edited separately
...
| Planning Slot | Working Title | File | Status | Function |
|---|---|---|---|---|
| B14.090 | The Unwound Core | [scratchpad beats](../scratchpad/14_09_the_unwound_core_beats.md) | Scratchpad expanded | Complete historical Architect Council meeting; canonical source conversation for Book 01 First Mirror adaptation. Not prose yet. |
